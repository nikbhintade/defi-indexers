...
describe("supply / borrow flow", () => {
  it("updates Reserve / UserReserve / history with exact values", async () => {
        ...
        1: {
          simulate: [
            ...
            // rates + indexes
            {
              ...
              block: { number: 16776250, timestamp: 1671000250 },
            ...
            // borrow: variable debt token Mint (value 0.5 USDC, index RAY)
            {
              ...
              block: { number: 16776400, timestamp: 1671000400 },
    ...
    const supply = await indexer.Supply.getOrThrow("16776300:0:0xe1:1");
    ...
    const borrow = await indexer.Borrow.getOrThrow("16776400:0:0xe2:1");
