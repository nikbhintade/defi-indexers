 ...
 * JSON-serialized into the SPIKO_CALL_MOCK env var (worker threads copy the
...
export const REVERTED = Symbol.for("spiko-morpho.reverted");
...
export const CALL_MOCK_ENV = "SPIKO_CALL_MOCK";
