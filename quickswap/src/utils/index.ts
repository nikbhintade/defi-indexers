/**
 * Port of mappings/helpers.ts (numeric helpers and constants) plus graph-node
 * BigDecimal semantics. The eth_call helpers (fetchTokenName / fetchTokenSymbol
 * / fetchTokenDecimals / fetchTokenTotalSupply / balanceOf) live in
