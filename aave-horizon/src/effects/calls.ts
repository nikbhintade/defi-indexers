 ...
 * AAVE_HORIZON_CALL_MOCK env var (worker threads copy the parent env at creation).
 */
...
export const REVERTED = Symbol.for("aave-v3.reverted");
...
export const CALL_MOCK_ENV = "AAVE_HORIZON_CALL_MOCK";
