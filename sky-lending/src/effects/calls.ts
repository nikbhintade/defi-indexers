 ...
 * value: JSON-serialized into the SKY_CALL_MOCK env var (worker
...
export const REVERTED = Symbol.for("sky-lending.reverted");
...
export const CALL_MOCK_ENV = "SKY_CALL_MOCK";
