 ...
 * symbol, name, underlying) is left unpinned.
 *
 ...
 * value: JSON-serialized into the COMPOUND_V2_CALL_MOCK env var (worker
...
export const REVERTED = Symbol.for("compound-v2.reverted");
...
export const CALL_MOCK_ENV = "COMPOUND_V2_CALL_MOCK";
